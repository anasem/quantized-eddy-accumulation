...
sim_perf_eval <- merge(sim_base_treatments, sim_qea, by = "aiid")

# Summarize results  -----------------------------------------------------------

sim_perf_eval[, station := station_name]

# Define flux errors as true - measured; preifix fe_: flux error
sim_perf_eval[, co2_flux_q0_cc := co2_flux_q0 * w_sd/ wq0_sd]
sim_perf_eval[, h2o_flux_q0_cc := h2o_flux_q0 * w_sd/ wq0_sd]
sim_perf_eval[, fe_co2_bts := co2_flux - co2_flux_bts ]
sim_perf_eval[, fe_h2o_bts := h2o_flux - h2o_flux_bts]
sim_perf_eval[, fe_co2_ldb_bts := co2_flux - co2_flux_ldb_bts]
sim_perf_eval[, fe_h2o_ldb_bts := h2o_flux - h2o_flux_ldb_bts]
sim_perf_eval[, fe_co2_ldb_bcst := co2_flux - co2_flux_ldb_bcst]
sim_perf_eval[, fe_h2o_ldb_bcst := h2o_flux - h2o_flux_ldb_bcst]
sim_perf_eval[, fe_co2_ldb_bw := co2_flux - co2_flux_ldb_bw]
sim_perf_eval[, fe_h2o_ldb_bw := h2o_flux - h2o_flux_ldb_bw]
sim_perf_eval[, fe_ts_ldb_bw :=  ts_flux - ts_flux_ldb_bw ]
#
sim_perf_eval[, fe_co2_q := co2_flux - co2_flux_q]
sim_perf_eval[, fe_h2o_q := h2o_flux - h2o_flux_q]
sim_perf_eval[, fe_ts_q := ts_flux - ts_flux_q]
sim_perf_eval[, fe_co2_q0 := co2_flux - co2_flux_q0_cc]
sim_perf_eval[, fe_h2o_q0 := h2o_flux - h2o_flux_q0_cc]
#
# Treatments with DB1 
sim_perf_eval[, fe_co2_db1_bw := co2_flux - co2_flux_db1_bw]
sim_perf_eval[, fe_h2o_db1_bw := h2o_flux - h2o_flux_db1_bw]
sim_perf_eval[, fe_ts_db1_bw :=  ts_flux - ts_flux_db1_bw ]
#
sim_perf_eval[, fe_co2_db1_bts := co2_flux - co2_flux_db1_bts]
sim_perf_eval[, fe_h2o_db1_bts := h2o_flux - h2o_flux_db1_bts]
sim_perf_eval[, fe_co2_db1_bcst := co2_flux - co2_flux_db1_bcst]
sim_perf_eval[, fe_h2o_db1_bcst := h2o_flux - h2o_flux_db1_bcst]
...
if (save_output) {
    ...
    saveRDS(sim_perf_eval, file = sim_perf_eval_fn)
}
