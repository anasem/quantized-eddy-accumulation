...
# Run simulation ---------------------------------------------------------------
ec_dt[, grp_id := .GRP, by = aiid]
ec_dt_splits <- split(ec_dt, cut(ec_dt[, grp_id], 
...
# Normalized errors
sim_param_spc[, ndfe_co2_q := fe_co2_q/ w_sd/ co2_sd]
sim_param_spc[, ndfe_h2o_q := fe_h2o_q/ w_sd/h2o_sd]
sim_param_spc[, ndfe_Ts_q  := fe_ts_q/w_sd/Ts_sd  ]
